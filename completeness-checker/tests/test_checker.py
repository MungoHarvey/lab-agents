...
@patch("checker.get_experiment_state")
@patch("checker.send_slack_notification")
def test_run_check_summary_when_many_flagged(mock_notify, mock_state, tmp_path):
    """When >10 experiments are flagged, send a summary instead of individual messages."""
    notified_path = str(tmp_path / "last_checked.json")
    mock_state.return_value = {"type": "doc", "content": []}  # Empty doc — all sections missing
    ...
    # Should send exactly 1 summary message, not 15 individual ones
